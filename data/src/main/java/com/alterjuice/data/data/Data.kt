package com.alterjuice.data.data

import com.alterjuice.data.other.YumHubGson
import com.alterjuice.domain.model.common.YumHubMeal
import com.alterjuice.network.toYumHubMeal
import com.alterjuice.network.xanthir.MealWithRecipeDTO
import com.google.gson.reflect.TypeToken


fun getMealWithRecipeItems(): List<MealWithRecipeDTO> {
    val g = YumHubGson.generateGson()
    val x = TypeToken.getParameterized(List::class.java, MealWithRecipeDTO::class.java)
    val items = g.fromJson<List<MealWithRecipeDTO>>(jsonData, x.type)
    return items
}

fun getMealWithRecipeItemsAsYumHubMeals(dropEmptyNutrients: Boolean = true): List<YumHubMeal> {
    val meals = getMealWithRecipeItems().map { it.toYumHubMeal() }
    return if (dropEmptyNutrients) {
        meals.filterNot {
            it.mainNutrients.all { it?.value == null || it.value == 0.0 }
        }
    } else {
        meals
    }
...
val jsonData = """[
   {
    ...
    },
    {
        ...
        "ingredients": [
            ...
            "1\/4 cup fresh berries\r",
            "<hr>\r",
            "1 1\/2 tbsp olive oil\r",
            "2 tsp balsamic vinegar\r",
    ...
    },
    {
        ...
        "sugar": 7,
        "protein": 43,
        "instructions": "In a small pot, heat oil over medium. Add onion and garlic and cook until onion is soft and garlic is fragrant, 3 minutes. Add seasoning and cook until fragrant, 1 minute. Add beans, water (using bean water if possible), salt, and pepper, and simmer until beans are heated through, 5 minutes. Mash in pan with wooden spoon.\r\n\r\nSeason to taste with salt and pepper if needed. Serve with tortillas, cheese, avocado, lettuce, and jalapenos.",
        "ingredients": [
            "1 tsp extra-virgin olive oil\r",
            "1\/2 small yellow onion, diced small\r",
            "2 garlic cloves, roughly chopped\r",
            "1\/2 tsp taco seasoning\r",
            "1 cup black beans, ideally *not* drained\r",
            "1\/4 cup water\r",
            "coarse salt and ground pepper\r",
            "<hr>\r",
            "4 flour tortillas, warmed or lightly toasted\r",
            "2\/3 cup Monterey Jack cheese, shredded (1 cup \u2248 3 oz)\r",
            "1\/2 avocado, pitted, peeled and thinly sliced\r",
            "1 cup packed shredded romaine lettuce\r",
    ...
    {
        "id": "id174",
        "name": "Pasta with asparagus and egg",
    ...
    },
    {
        ...
        "ingredients": [
            ...
            "2 tbsp yellow curry paste\r",
            "4 garlic cloves, pressed\r",
            "1 1\/2 tbsp ginger\r",
            "2 can lite coconut milk\r",
            "1\/2 medium head cauliflower, cut into small florets\r",
            "2 tbsp lemon juice\r",
            "1 cup frozen peas\r",
            "1 3\/4 tsp salt"
        ],
    ...
    },
    {
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "Heat 2 tablespoons oil over medium heat in another saucepan. Cook onion, stirring frequently, until soft, 6 to 7 minutes. Add rice, cook, stirring, until edges are translucent, 2 to 3 minutes. Add wine; cook, stirring, just until evaporated.\r\n\r\nAdd stock; cook about 20 minutes, stirring occasionally, until almost absorbed.\r\n\r\nMeanwhile, roast the asparagus at 400F for 5 minutes, then let cool and chop to bite-size. Add asparagus and peas to the risotto about 1 minute before risotto is done.\r\n\r\nRemove from heat; stir in lemon zest and juice, parsley, cheese, and remaining 2 tablespoons oil. Season with salt and pepper. Serve immediately with additional cheese and lemon zest.",
        "ingredients": [
    ...
    },
    {
        ...
        "ingredients": [
            "Coarse salt and ground pepper\r",
            "6 ounce ziti rigate (ridged) or other short pasta\r",
    ...
    },
    {
        ...
        "sugar": 0,
        "protein": 60,
        "instructions": "Preheat oven to 400F. Thaw pie crust if needed. If using a crust *under* the pie (rather than an overcrust), pre-bake as directed (10-12 minutes).\r\n\r\nHeat oil in 12-inch skillet or medium pot over medium high heat 1-3 minutes or until shimmering. Add potatoes, cauliflower, and onion; cook and stir 1 minute. Reduce heat to medium-low. Add carrots; cook, covered 5 minutes, stirring occasionally. Add mushrooms; cook, covered 5-7 minutes or until potatoes are tender, stirring occasionally. Stir in asparagus, peas, salt and pepper; remove skillet from heat.\r\n\r\nMeanwhile, combine 1\/3 of the milk and flour in a small bowl; whisk until smooth. In small saucepan, bring remaining milk to a simmer over medium-low heat. Add boursin to saucepan; whisk well. Gradually add flour mixture; whisk until smooth. Bring to a simmer; cook 1 minute, whisking constantly. Add cheese sauce and parsley to skillet, mix gently.\r\n\r\nPour filling into a deep dish pie plate, and top with pie crust. Bake 15 minutes or until golden brown and filling starts to bubble. Let stand 5 minutes before serving. ",
        "ingredients": [
            "1 tsp olive oil\r",
    ...
    },
    {
        ...
        "ingredients": [
            ...
            "1 tsp sugar\r",
            "add-ins (somen, seaweed, tofu, etc)\r",
    ...
    },
    {
        ...
        "ingredients": [
            ...
            "2 clove garlic\r",
            "1 cup parmesan cheese, freshly grated\r",
            "3\/4 cup pine nuts, toasted\r",
    ...
    },
    {
        ...
        "ingredients": [
            ...
            "1 tbsp hoisin sauce\r",
            "5 cup water\r",
            "6 oz baby bok choy, roughly chopped\r",
    ...
    },
    {
        ...
        "sugar": 12,
        "protein": 28,
        "instructions": "Gently coat the brussels sprouts with oil, salt, and pepper. Add oil to a medium-size pan, and bring up to medium heat, then add sprouts, cut side down. Cover and cook for 5 minutes, until the sprouts are tender and only very slightly browned.\r\n\r\nUncover, turn heat up to medium-high, and cook for a few minutes, until cut sides are golden and caramelized. Flip and cook for another minute or two, to get some browning on the round side. Season to taste, then serve immediately, topping with parmesan.",
        "ingredients": [
            "24 small Brussels sprouts, trimmed and halved\r",
            "1 tbsp extra-virgin olive oil\r",
            "Salt\r",
            "Black pepper\r",
    ...
    },
    {
        ...
        "ingredients": [
            ...
            "1\/4 tsp salt\r",
            "1\/4 cup rolled oats\r",
            "1\/8 cup flour (or almond meal)\r",
    ...
    },
    {
        ...
        "sugar": 24,
        "protein": 25,
        "instructions": "Whisk chia seeds, milk, vanilla, and honey until combined. Let rest a few minutes, whisk again as it begins to thicken, then chill overnight.\r\n\r\nStir in remaining ingredients before serving.",
        "ingredients": [
            "1\/4 cup chia seeds\r",
            "1 cup milk\r",
            "1 tsp vanilla\r",
            "1 tsp honey or sugar\r",
            "<hr>\r",
            "2 tbsp peanut butter\r",
            "1\/2 cup fruit, diced"
        ],
    ...
    {
        "id": "id598",
        "name": "Crunchy chickpea pita pockets",
        "source": "Hello Fresh",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 1200,
        "servings": 2,
        "comments": "Cut amount of chickpeas in half",
        "calories": 1470,
        "fat": 46,
        "satfat": 22,
        "carbs": 130,
    ...
    },
    {
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "Preheat oven to 450F. Trim the ends of the delicata. Cut in half and scoop out the seeds. Rub all surfaces with olive oil, salt, and pepper, then place cut-side-down on a baking sheet. Bake for 20min, or until browned and tender when pierced with a fork.\r\n\r\nCook the rice per package directions, then decant to a mixing bowl.\r\n\r\nIn a small pot, combine the vinegar, brown sugar, and water; season to taste. Whisk together, then add the figs. Bring to a boil, stirring occasionally, for 1-2 minutes until well-coated.\r\n\r\nIn a medium pan, saute the onion 2-3 minutes, until softened. Add the peppers and carrots, season, then cook 4-5 minutes. Add garlic, cook for an additional 1-2 minutes. Transfer to the rice, add the parmesan and half the feta. Mix well.\r\n\r\nFill the squash halves with filling; serve the remaining filling alongside\/under the squash. Garnish with the pickled figs and remaining feta.",
        "ingredients": [
            "1\/2 cup rice\r",
            "1 delicata squash\r",
            "2 figs, diced\r",
            ...
            "1\/4 cup water\r",
            "2 clove garlic, roughly chopped\r",
            "1 yellow onion, small diced\r",
            "3 oz shishito peppers, medium diced crosswise\r",
            "1 large carrot, medium diced\r",
            "1 1\/2 oz feta cheese\r",
    ...
    {
        "id": "id600",
        "name": "Fairy Tale Eggplant Pizza",
        "source": "Blue Apron",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 2400,
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "Preheat oven to 475F.\r\n\r\nHeat a large pan with olive oil to medium heat. Arrange the eggplant in a single layer, and cook without stirring 2-3 minutes, until lightly browned. Add chives and half the garlic, season. Cook 1-2 minutes until softened. Add tomato paste and water, and cook 1-2 minutes, stirring frequently, until dark red and fragrant.\r\n\r\nLay out the pizza dough. Top with mozzarella and eggplant, and bake 15 minutes, until crust is golden brown and cheese has melted.\r\n\r\nMeanwhile, blister the tomatoes at medium-high for 3-4 minutes, until browned. Add half the vinegar and season, cooking for another 30s-1min, until slightly thickened. Transfer to a bowl.\r\n\r\nLayer squash in a single layer and cook 2-3 minutes without stirring, until lightly browned. Add remaining garlic and season, stirring and cooking for another 2-3 minutes. Add fig and remaining vinegar, stir to combine. Add to tomatoes and gently combine.\r\n\r\nWhen serving, top salad with parmesan and half the basil; add remaining basil to pizza.",
        "ingredients": [
            "1\/2 lb fairy tale eggplant, 1\/4-inch slices\r",
            "1 tbsp capers\r",
            "2 clove garlic, roughly chopped and divided\r",
            "2 tbsp tomato paste\r",
            "2 tbsp water\r",
            "1\/2 lb fresh mozzarella, torn into bite-size pieces\r",
            "1\/2 cup cherry tomatoes, whole\r",
            "2 tbsp red wine vinegar, divided\r",
            "1 large fig, diced\r",
            "1 small zucchini (or other squash), 1\/2-inch half moons\r",
            "1 tbsp basil, chiffonaded\r",
            "1\/2 lb pizza dough"
        ],
        "tags": [
            "vegetarian",
    ...
    {
        "id": "id601",
        "name": "Vegetarian Jjajangmyeon",
        "source": "https:\/\/www.maangchi.com\/recipe\/jjajangmyeon",
        "preptime": 900,
        "waittime": 0,
        "cooktime": 1200,
        "servings": 2,
        "comments": "Adapted to use mushroom instead of pork",
        "calories": 0,
        "fat": 0,
        "satfat": 0,
        "carbs": 0,
    ...
    {
        "id": "id602",
        "name": "Cheese Board Bento",
        "source": "https:\/\/www.hormelfoods.com\/inspired\/story\/the-bold-and-the-bento\/",
        "preptime": 0,
        "waittime": 0,
        "cooktime": 0,
        "servings": 1,
        "comments": "Heavily edited due to calories in original recipe",
        "calories": 504,
        "fat": 33,
        "satfat": 0,
        "carbs": 38,
        ...
        "sugar": 0,
        "protein": 19,
        "instructions": "Toss apple pieces with lemon juice to prevent browning. Arrange ingredients in bento box. ",
        "ingredients": [
            "1\/2 oz parmesan cheese, broken into rustic bite-sized pieces\r",
            "1\/2 oz cheddar cheese, broken into rustic bite-sized pieces\r",
            "1\/4 cup castelvetrano olives\r",
            "1\/2 cup grapes\r",
            "1\/2 apples, cut into wedges or large pieces\r",
            "2 tsp lemon juice\r",
    ...
    {
        "id": "id603",
        "name": "Chocolate Chip Cookies (NYT)",
        ...
        "ingredients": [
            "8.5 oz cake flour\r",
            "8.5 oz bread flour\r",
            "1 1\/4 teaspoon baking soda\r",
            "1 1\/2 teaspoon baking powder\r",
            "1 1\/2 teaspoon coarse salt\r",
            "1 1\/4 cup unsalted butter (2\u00bd sticks)\r",
            "10 oz light brown sugar\r",
            "8 oz granulated sugar\r",
            "2 large eggs\r",
            "2 teaspoon vanilla extract\r",
            "1 1\/4 pound semisweet chocolate chips\r",
            "Sea salt"
        ],
        "tags": [
            "cookies"
    ...
    {
        "id": "id604",
        "name": "Vegetable Fried Rice with Broccoli, Carrots, & Spicy Pepper Sauce",
        "source": "Blue Apron",
        "preptime": 1200,
        "waittime": 0,
        "cooktime": 0,
    ...
    {
        "id": "id605",
        "name": "Oden (Japanese fish cake stew)",
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "**Slow Cooker Instructions**\r\n\r\nStart the dashi and seasonings in the slow cooker at Low. If prepping from dried, soak the dashi bags for two hours, then remove. Hardboil the eggs.\r\n\r\nPrep the kombu, daikon, tofu cutlet, and oden set as specified below. (If the oden didn't come with hanpen, add a separate hanpen as well.) Add to broth (once dashi bags are removed, if necessary) and cook for 5-6 hours on Low. Gently stir occasionally.\r\n\r\nAdd the konyakku (slicing beforehand, if not using noodles) and mochi\/aburaage to the broth, and turn up to High for 30min. If eggs are cooled, add to the broth 5-10 minutes before finished to warm them.\r\n\r\nServe with mustard in a tasting bowl on the side.\r\n\r\n**Kombu** \r\n\r\nNote: If you can't find knotted kombu, hydrate a large piece of kombu, cut it into individual strips, and tie a knot in each; if the hydrated kombu is very thick and not pliable, cut it into smaller strips or squares and skip tying the knots.\r\n\r\n**Daikon Radish**\r\nWith the knife, remove the sharp edges of the daikon slices to smooth them out. This technique is called \"mentori.\" The rounded corners and edges will prevent the daikon from breaking and protect its shape. Next, score a cross on one flat side of the daikon slices, about \u00bc inch deep, so they will absorb more flavors.\r\n\r\nIf you are going to serve rice with the oden, reserve the cloudy water from rinsing the rice. Fill a medium pot with this cold, cloudy water. Add the daikon to the pot. Turn on the stove to medium heat and cook, uncovered, for about 20 minutes. Drain and rinse the daikon in running water. Set aside. Tip: This method helps get rid of the daikon's bitterness and odor and makes the daikon a beautiful white color. Make sure to cook the daikon starting with cold water. This allows the center of the daikon to cook slowly before the water reaches a boil and that will help cook the daikon evenly.\r\n\r\n**Konnyaku**\r\nBring a small saucepan of water to a boil. Meanwhile, score one side of the konnyaku in a crisscross pattern: Make diagonal cuts in one direction about \u215b inch (3 mm) deep and \u215b inch (3 mm) apart, then repeat the diagonal cuts in the other direction. This will help the konnyaku absorb more flavors.\r\nNext, cut the konnyaku into thirds crosswise. Then, cut each third in half diagonally, creating a triangle shape.\r\n\r\nPlace the konnyaku in the boiling water, cook for 3 minutes, and drain. Tip: This helps to remove the odor from the konnyaku.\r\n\r\n**Oden Set Prep**\r\nPut water in a donabe (Japanese clay pot) or a large, shallow pot and bring it to a boil. Add the oden set (Japanese fish cakes and fish balls\u2014we call them nerimono) to the boiling water for 15-30 seconds. Tip: This recommended step removes the excess deep-frying oil from factory processing.\r\n\r\nRemove the fish cakes and fish balls from the boiling water and transfer them to a plate or tray. Let cool. Keep the boiling water in the pot, if you are going to make mochi kinchaku. Otherwise, drain the water and rinse the pot.\r\n\r\n**Mochi Kinchaku**\r\nBlanch the aburaage (deep-fried tofu pouches) in the reserved boiling water for 15-30 seconds to remove the excess oil. Remove them from the water and set aside. Drain the water and rinse the pot.\r\nCut the aburaage in half crosswise to make two square pockets. Cut the kirimochi (rice cakes) in half or small enough to fit into the tofu pocket.\r\nOpen one aburaage pocket and put a piece of kirimochi inside. Use a toothpick to close the aburaage pouch so the mochi doesn't fall out during cooking. Repeat to make the remaining pouches.\r\n\r\n**Broth**\r\nTo the rinsed donabe or large pot, add the dashi (Japanese soup stock) and the rest of the seasonings for the oden broth. Mix well together.\r\n\r\n**Oden**\r\nPut the daikon, konnyaku, and peeled boiled eggs in the donabe (or pot) and bring it to a boil.\r\nOnce boiling, reduce the heat to low or medium low to maintain a simmer. Cook, uncovered, for 20 minutes.\r\nMeanwhile, cut the big pieces of fish cakes in the oden set in half or quarters so they are a convenient size to pick up with chopsticks. Here, I cut the larger Satsuma age (round fried fish cakes) into quarters and the chikuwa (baked fish cakes) diagonally in half.\r\nI cut the gobo-maki (burdock fish cake rolls) and fish balls in half.\r\nI cut the medium-sized Satsuma age in half. I cut the block of atsuage (thick, deep-fried tofu cutlet) in half crosswise and then cut each piece in half again diagonally.\r\nFor the small fish balls, you can thread two pieces onto a skewer to keep them together. Diagonally cut the hanpen (soft white fish cake) in quarters.\r\nAfter 20 minutes, check your oden pot. If there's so much broth that your oden pot will overflow when you add the oden set and other fish cakes, transfer some broth to a measuring cup (or bowl) and set aside. You can add this reserved broth to the pot later, as needed.\r\nNow, add the oden set, other fish cakes, and dried knotted kombu to the pot and cook for 10 minutes.\r\nAfter 10 minutes, add the hanpen (and the optional mochi kinchaku). Cook for 3 minutes. Now, your oden is ready to serve.\r\n\r\n**To Serve**\r\nServe hot. Oden is usually served with a little bit of karashi (hot mustard) on the side. To make karashi, combine 2 tsp of karashi powder with 3 tsp (1 Tbsp) of hot water in a small bowl.\r\nMix together, cover the bowl with plastic wrap, and flip upside down to let it steam under the bowl for 5 minutes to get a good taste and aroma. Unwrap the bowl and the karashi is ready to use.",
        "ingredients": [
            "4 inches daikon radish, peeled and sliced into round pieces 1 inch thick\r",
            "9 oz konnyaku (konjac, preferably noodle form)\r",
            "27 oz oden set\r",
            "6.5 oz deep-fried firm tofu cutlet (atsuage)\r",
            "2 pieces aburaage (deep-fried tofu pouch)\r",
            "2 pieces kirimochi\r",
            "4 hard-boiled eggs, cooled and peeled\r",
            "4.6 oz hanpen (fish cake \/ optional)\r",
            "4 pieces dried knotted kombu\r",
            "<hr>\r",
            "6 cup dashi\r",
            "2 Tbsp soy sauce\r",
            "1 Tbsp sake\r",
    ...
    {
        "id": "id606",
        "name": "Seared tilapia and lemon-caper sauce",
        "source": "Blue Apron",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 1500,
    ...
    {
        "id": "id607",
        "name": "Irish Buttermilk Brown Bread",
        "source": "King Arthur Flour Feb 2023",
        "preptime": 1200,
        "waittime": 600,
        "cooktime": 2400,
        "servings": 1,
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "Preheat oven to 400F. Grease an 8\" round pan and place a liner on the bottom.\r\n\r\nIn a large bowl, stir together the flour, sugar, salt, baking soda, and baking powder.\r\n\r\nMake a large hole in the center of the dry ingredients and pour in the buttermilk and butter. Stir together until blended; some lumps will remain.\r\n\r\nTurn the dough out onto a floured surface and knead about 10 times, or until it all holds together. Form the dough into a ball and place it in the prepared pan. Cut a deep cross in the top.\r\n\r\nBake the bread for ~40min, or until a paring knife inserted in the center comes out clean. \r\n\r\nRemove the bread from the oven, tip it out of the pan, and cool on a rack.",
        "ingredients": [
            "4 cup whole-wheat flour\r",
            "3 tbsp granulated sugar\r",
            "1 tsp salt\r",
            "1 tsp baking soda\r",
            "2 tsp baking powder\r",
            "1 1\/2 cup buttermilk\r",
    ...
    },
    {
        ...
        "cooktime": 900,
        "servings": 1,
        "comments": "Chikuwa cucumber recipe https:\/\/www.justonecookbook.com\/chikuwa-cucumber\/",
        "calories": 426,
        "fat": 11,
        "satfat": 2,
        "carbs": 48,
        ...
        "ingredients": [
            ...
            "<hr>\r",
            "1 chikuwa, thawed\r",
            "1\/4 Persian cucumber, see instructions for prep note\r",
            "<hr>\r",
            "3 broccoli florets, blanched\r",
            "3 grape tomatoes\r",
            "soy sauce, or other dipping sauce\r",
            "furikake"
        ],
        "tags": [
            "bento"
    ...
    {
        "id": "id609",
        "name": "Pan fried tofu and soba noodle bento",
        ...
        "cooktime": 0,
        "servings": 1,
        "comments": "the tofu probably needs more seasoning",
        "calories": 430,
        "fat": 14,
        "satfat": 1,
        "carbs": 53,
    ...
    {
        "id": "id610",
        "name": "Black bean plantain bowls",
        "source": "https:\/\/plantbasedrdblog.com\/2023\/03\/black-bean-plantain-bowls-with-crispy-garlic-rice",
        "preptime": 900,
        "waittime": 0,
        "cooktime": 1800,
        "servings": 2,
        "comments": "adjusted ingredients to make 2 serving sizes",
        "calories": 1220,
        "fat": 26,
        "satfat": 4,
        "carbs": 220,
    ...
    },
    {
        ...
        "source": "https:\/\/plantbasedrdblog.com\/2022\/02\/easy-mexican-pickled-onions\/",
        "preptime": 300,
        "waittime": 1800,
        "cooktime": 0,
        "servings": 12,
    ...
    {
        "id": "id612",
        "name": "Elote-style vegetable tostadas",
        "source": "Blue Apron",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 2100,
        "servings": 2,
        "comments": "Reduced the amount of rice and tortillas",
        "calories": 1224,
        "fat": 80,
        "satfat": 10,
        "carbs": 114,
    ...
    {
        "id": "id613",
        "name": "Grilled halloumi and vegetables",
        "source": "NYT Cooking",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 900,
    ...
    {
        "id": "id614",
        "name": "Grilled Tomato Gnocchi Kebabs",
        "source": "https:\/\/www.delish.com\/cooking\/recipe-ideas\/a39540438\/tomato-gnocchi-kebabs-recipe\/",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 1200,
        "servings": 4,
        ...
        "ingredients": [
            ...
            "salt\r",
            "<hr>\r",
            "12 oz fresh gnocchi\r",
            "4 cup cherry tomatoes\r",
            "2 small red onions, cut into 2\" pieces\r",
            "6 portobello mushrooms, cut into 2\" pieces\r",
            "2 tbsp extra-virgin olive oil\r",
            "salt\r",
            "freshly ground black pepper"
        ],
    ...
    },
    {
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "1. Toss **sliced cucumber** with **salt** and **rice vinegar** in a medium bowl. Let sit at room temperature, tossing occasionally, until ready to serve.\r\n\r\n2. Press **tofu** if you haven't already. Meanwhile, puree **pear**, **ginger**, **garlic**, **soy sauce**, **sesame oil**, **brown sugar**, **gochugaru**, **vegetable oil**, and **rice vinegar** in a blender until very smooth. Pour half of marinade into a large baking dish (use smaller dish if making less servings).\r\n\r\n3. Slice each block of **tofu** crosswise into 6 slabs (2 slabs per servings, adjust for serving size). Arrange tofu in a single layer in baking dish, then pour remaining marinade over. Cover and chill 30 minutes.\r\n\r\n4. Prepare a grill for medium-high heat; clean and oil grate. Remove tofu from marinade, letting excess drip back into dish and transfer to a clean rimmed baking sheet; reserve **marinade** for glazing and making sauce. Whisk **gochujang** into reserved marinade.\r\n\r\n5. Place tofu on grate, brush with **marinade**, and grill under deep brown marks appear, about 5 minutes. Carefully turn tofu over and brush second side with marinade. Grill under deep brown marks appear, about 5 minutes. Return tofu to baking sheet.\r\n\r\n6. Toast **hamburger buns**, cut side down on grill until golden, about 1 minute. Transfer to plates.\r\n\r\n7. Whisk **mayo** and **reserved marinade** in a small bowl. Spread cut side of buns with sauce. Build burgers with **2 slabs of tofu each**, followed by some **pickled cucumber** slices.\r\n\r\nDo ahead: Cucumber can be pickled 1 day ahead. Cover and chill.",
        "ingredients": [
            "1 English cucumber, thinly sliced on a diagonal\r",
            "1\/2 tsp kosher salt\r",
            "3 Tbsp unseasoned rice vinegar\r",
            "<hr>",
            "2 14-oz blocks extra-firm tofu, drained and pressed for 15 minutes\r",
            "1 Asian pear, cored, coarsely chopped\r",
            "1 2-in piece ginger, peeled, thinly sliced\r",
            "2 garlic cloves\r",
            "1\/4 cup soy sauce\r",
            "2 Tbsp toasted sesame oil\r",
            "1 Tbsp brown sugar\r",
            "1 Tbsp gochugaru\r",
            "3 Tbsp vegetable oil\r",
            "3 Tbsp unseasoned rice vinegar\r",
            "<hr>",
            "2 Tbsp gochujang\r",
            "6 hamburger buns, split\r",
            "1\/3 cup mayonnaise\r",
            "3 Tbsp reserved marinade from recipe"
        ],
        "tags": [
            "vegetarian",
            "main",
    ...
    {
        "id": "id616",
        "name": "Easy potsticker soup",
        "source": "https:\/\/flybyjing.com\/blog\/easy-creamy-potsticker-soup",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 1200,
        "servings": 2,
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "To a medium pot over medium heat add **sesame oil**. Add the **garlic**, **ginger** and **onion** and saut\u00e9 for 3-4 minutes until softened.\r\n\r\nAdd in the **vegetable stock paste**, **miso**, **coconut cream** and **Zhong Sauce**, stir just to combine and then pour in the water, stirring or whisking constantly to combine.\r\n\r\nBring to a simmer over medium-high heat and then add in the **vegetable dumplings** and **spinach**, cook for about 5-7 minutes at a simmer over medium-low heat or until frozen dumplings are just done (cook time may also vary according to package directions).\r\n\r\nOnce the dumplings are cooked, taste and adjust the seasoning in the soup broth if necessary.\r\n\r\nTake the soup off the heat and stir in the **silken tofu**.\r\n\r\nServe the soup in a bowl topped with **Sichuan Chili Crisp**, chopped **green onions**, and **sesame seeds**. Enjoy!",
        "ingredients": [
            "1 tbsp sesame oil\r",
            "2 garlic cloves, minced\r",
            "1 inch ginger root, minced or grated\r",
            "1 small onion, grated or minced\r",
            "1\/2 tbsp vegetable stock paste\r",
            "1 tbsp miso paste\r",
            "1\/2 cup coconut cream\r",
            "2 1\/2 cup water\r",
            "2 tbsp Zhong Sauce\r",
            "10 frozen vegetable potstickers\r",
            "<hr>\r",
            "7 oz silken tofu, cubed\r",
            "Sichuan Chili Crisp\r",
            "5 green onions, chopped\r",
            "white or black sesame seeds\r",
            "2 cup spinach"
        ],
        "tags": [
            "vegetarian",
    ...
    {
        "id": "id617",
        "name": "Katsu-style eggplant with stir-fried green beans and sweet peppers",
        "source": "Blue Apron",
        "preptime": 1200,
        "waittime": 0,
        "cooktime": 1440,
        "servings": 2,
        "comments": "(see instructions for grill prep, instead)",
        "calories": 1341,
        "fat": 51,
        "satfat": 8,
        "carbs": 186,
        ...
        "ingredients": [
            ...
            "2 tbsp rice vinegar\r",
            "1 tbsp sesame oil\r",
            "2 tbsp tonkatsu sauce (or ketchup and Worcestershire sauce) \r",
            "<hr>\r",
            "4 oz sweet peppers, cut into quarters lengthwise, stems, ribs, and seeds removed\r",
            "6 oz green beans, trimmed\r",
            "1 1-inch piece ginger, finely chopped\r",
            "1\/4 cup water\r",
            "2 tbsp peanuts, roughly chopped\r",
    ...
    },
    {
        "id": "id618",
        "name": "Yakiniku sauce",
        "source": "https:\/\/www.justonecookbook.com\/yakiniku-sauce\/",
        "preptime": 600,
        "waittime": 0,
        "cooktime": 0,
        "servings": 1,
        ...
        "sugar": 0,
        "protein": 0,
        "instructions": "Transfer the **grated onion and all of its juice** to a mason jar or microwave-safe container. Add the **pressed garlic**, **grated ginger**, **gochujang**, **soy sauce**, **sugar**, and **sesame seeds**. Microwave the sauce for 30\u201335 seconds until it's hot enough to dissolve the sugar. Add **toasted sesame oil** and mix well. The Yakiniku Sauce is now ready to use. Full recipe yield about 1\/3 cup.",
        "ingredients": [
            "1\/4 medium yellow onion, 75 g; grated, with juice\r",
            "3 clove garlic, pressed\r",
            "1\/8 tsp ginger, grated\r",
            "1\/4 tsp gochujang\r",
            "1\/4 cup soy sauce\r",
            "2 Tbsp sugar\r",
            "1\/2 Tbsp toasted white sesame seeds\r",
            "<hr>\r",
