...
public final class RuntimeTypeAdapter<T> implements TypeAdapterFactory {
    ...
    private RuntimeTypeAdapter(Class<?> baseType, String typeFieldName, boolean maintainType) {
     ...
     */
    public static <T> RuntimeTypeAdapter<T> of(Class<T> baseType, String typeFieldName, boolean maintainType) {
        return new RuntimeTypeAdapter<>(baseType, typeFieldName, maintainType);
    }
    ...
    public static <T> RuntimeTypeAdapter<T> of(Class<T> baseType, String typeFieldName) {
        return new RuntimeTypeAdapter<>(baseType, typeFieldName, false);
    }
    ...
    public static <T> RuntimeTypeAdapter<T> of(Class<T> baseType) {
        return new RuntimeTypeAdapter<>(baseType, "type", false);
    }
